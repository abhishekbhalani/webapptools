////////////////////////////////////////////////////////////////////////////////////////////////////
/// @file   externals\dtl.hpp
///
/// @brief  dtl-1.00 -- Diff Template Library 
///
/// Difference builder library: http://code.google.com/p/dtl-cpp/ @n
/// dtl can compare two sequences have arbitrary type, however sequence must support
/// random access iterator.
///
/// @author Copyright(C) 2008-2009  Tatsuhiko Kubo <cubicdaiya@gmail.com>
////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef DTL_H
#define DTL_H
...
/**
	@namespace	dtl
	@brief  Diff Template Library. 
	@page dtl Diff Template Library
*/
namespace dtl {
    ...
    */
    ...
    const   editType SES_DELETE = -2;     ///< 23.06.2009: fixed by A. Abramov to reach weCmpState compatibility
    const   editType SES_COMMON = 0;
    const   editType SES_ADD    = 2;      ///< 23.06.2009: fixed by A. Abramov to reach weCmpState compatibility
