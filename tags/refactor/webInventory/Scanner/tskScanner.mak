...
Debug_target.BIN = Debug/tskScanner
Debug_target.OBJ = ../Common/programcfg.o ../Common/weObject.o ../Common/weProfile.o taskexec.o tskScanner.o watchdog.o 
DEP_FILES += ../Common/programcfg.d ../Common/weObject.d ../Common/weProfile.d taskexec.d tskScanner.d watchdog.d 
...
Debug_target : LDFLAGS += -L../../webEngine/libs/debug   
Debug_target : T_LDLIBS = -lwebEngine -llog4cxx -lboost_regex-mt -lboost_date_time-mt -lboost_system-mt -lboost_thread-mt -lboost_program_options-mt -lboost_serialization-mt -lcurl -lboost_filesystem-mt 
ifdef LMAKE
...
Release_target.BIN = Release/tskScanner
Release_target.OBJ = ../Common/programcfg.o ../Common/weObject.o ../Common/weProfile.o taskexec.o tskScanner.o watchdog.o 
DEP_FILES += ../Common/programcfg.d ../Common/weObject.d ../Common/weProfile.d taskexec.d tskScanner.d watchdog.d 
...
Release_target : LDFLAGS += -s -L../../webEngine/libs/release   
Release_target : T_LDLIBS = -lwebEngine -llog4cxx -lboost_thread-mt -lboost_system-mt -lboost_serialization-mt -lboost_program_options-mt -lboost_date_time-mt -lboost_filesystem-mt -lcurl -lboost_regex-mt 
ifdef LMAKE
