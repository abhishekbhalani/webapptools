...
MainForm::MainForm( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_stLogLevel->Wrap( -1 );
	gbSizer2->Add( m_stLogLevel, wxGBPosition( 0, 0 ), wxGBSpan( 1, 1 ), wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	...
	m_staticText231 = new wxStaticText( m_panTaskOpts, wxID_ANY, _("Task logs tail"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText231->Wrap( -1 );
	m_staticText231->SetToolTip( _("How much last lines will be accuried from task's log") );
	
	gbSizer2->Add( m_staticText231, wxGBPosition( 1, 0 ), wxGBSpan( 1, 1 ), wxALIGN_CENTER_VERTICAL|wxALIGN_RIGHT|wxALL, 5 );
	
	m_spinCtrl2 = new wxSpinCtrl( m_panTaskOpts, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 10, wxT("TaskTail<2>") );
	m_spinCtrl2->SetToolTip( _("How much last lines will be accuried from task's log") );
	
	gbSizer2->Add( m_spinCtrl2, wxGBPosition( 1, 1 ), wxGBSpan( 1, 1 ), wxALL, 5 );
	...
	m_toolBarTasks->SetToolBitmapSize( wxSize( 22,22 ) );
	...
	m_plgBook->Connect( wxEVT_COMMAND_LISTBOOK_PAGE_CHANGING, wxListbookEventHandler( MainForm::OnOptionsPageChanging ), NULL, this );
...
MainForm::~MainForm()
{
	...
	m_plgBook->Disconnect( wxEVT_COMMAND_LISTBOOK_PAGE_CHANGING, wxListbookEventHandler( MainForm::OnOptionsPageChanging ), NULL, this );
