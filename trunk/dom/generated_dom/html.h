...
class CSSFontFaceRule : ::css::CSSRule {
public:
    CSSFontFaceRule();
    const   v8::Handle<v8::Value> /*::css::CSSStyleDeclaration*/  style;
};
class CSSPageRule : ::css::CSSRule {
public:
    CSSPageRule();
    ::css::DOMString selectorText;
    const   v8::Handle<v8::Value> /*::css::CSSStyleDeclaration*/  style;
};
class CSSImportRule : ::css::CSSRule {
public:
    CSSImportRule();
...
class CSSCharsetRule : ::css::CSSRule {
public:
    CSSCharsetRule();
    ::css::DOMString encoding;
};
class CSSUnknownRule : ::css::CSSRule {
public:
    CSSUnknownRule();
};
class CSSStyleDeclaration {
...
class CSSPrimitiveValue : ::css::CSSValue {
public:
    CSSPrimitiveValue();
    enum  {
        CSS_UNKNOWN = 0,
...
class CSSValueList : ::css::CSSValue {
public:
    CSSValueList();
    const  unsigned long length;
...
class CSSStyleSheet : ::stylesheets::StyleSheet {
public:
    CSSStyleSheet();
...
class ViewCSS : ::views::AbstractView {
public:
    ViewCSS();
...
class DocumentCSS : ::stylesheets::DocumentStyle {
public:
    DocumentCSS();
...
class DOMImplementationCSS : ::css::DOMImplementation {
public:
...
class MouseEvent : ::events::UIEvent {
public:
    MouseEvent();
    const  long screenX;
    const  long screenY;
...
class MutationEvent : ::events::Event {
public:
    MutationEvent();
    enum  {
        MODIFICATION = 1,
...
class HTMLDocument : ::html2::Document {
public:
    HTMLDocument();
...
class HTMLElement : ::html2::Element {
public:
    HTMLElement();
    ::html2::DOMString id;
    ::html2::DOMString title;
...
class HTMLHeadElement : ::html2::HTMLElement {
public:
    HTMLHeadElement();
    ::html2::DOMString profile;
};
class HTMLLinkElement : ::html2::HTMLElement {
public:
    HTMLLinkElement();
    bool disabled;
...
class HTMLTitleElement : ::html2::HTMLElement {
public:
    HTMLTitleElement();
    ::html2::DOMString text;
};
class HTMLMetaElement : ::html2::HTMLElement {
public:
    HTMLMetaElement();
...
class HTMLBaseElement : ::html2::HTMLElement {
public:
    HTMLBaseElement();
    ::html2::DOMString href;
    ::html2::DOMString target;
};
class HTMLIsIndexElement : ::html2::HTMLElement {
public:
    HTMLIsIndexElement();
    const   v8::Handle<v8::Value> /*::html2::HTMLFormElement*/  form;
    ::html2::DOMString prompt;
};
class HTMLStyleElement : ::html2::HTMLElement {
public:
    HTMLStyleElement();
    bool disabled;
    ::html2::DOMString media;
...
class HTMLBodyElement : ::html2::HTMLElement {
public:
    HTMLBodyElement();
...
class HTMLFormElement : ::html2::HTMLElement {
public:
    HTMLFormElement();
...
class HTMLSelectElement : ::html2::HTMLElement {
public:
    HTMLSelectElement();
...
class HTMLOptGroupElement : ::html2::HTMLElement {
public:
    HTMLOptGroupElement();
    bool disabled;
    ::html2::DOMString label;
};
class HTMLOptionElement : ::html2::HTMLElement {
public:
    HTMLOptionElement();
    const   v8::Handle<v8::Value> /*::html2::HTMLFormElement*/  form;
...
class HTMLInputElement : ::html2::HTMLElement {
public:
    HTMLInputElement();
...
class HTMLTextAreaElement : ::html2::HTMLElement {
public:
    HTMLTextAreaElement();
    ::html2::DOMString defaultValue;
    const   v8::Handle<v8::Value> /*::html2::HTMLFormElement*/  form;
...
class HTMLButtonElement : ::html2::HTMLElement {
public:
    HTMLButtonElement();
    const   v8::Handle<v8::Value> /*::html2::HTMLFormElement*/  form;
    ::html2::DOMString accessKey;
...
class HTMLLabelElement : ::html2::HTMLElement {
public:
    HTMLLabelElement();
    const   v8::Handle<v8::Value> /*::html2::HTMLFormElement*/  form;
    ::html2::DOMString accessKey;
...
class HTMLFieldSetElement : ::html2::HTMLElement {
public:
    HTMLFieldSetElement();
    const   v8::Handle<v8::Value> /*::html2::HTMLFormElement*/  form;
};
class HTMLLegendElement : ::html2::HTMLElement {
public:
    HTMLLegendElement();
    const   v8::Handle<v8::Value> /*::html2::HTMLFormElement*/  form;
    ::html2::DOMString accessKey;
...
class HTMLUListElement : ::html2::HTMLElement {
public:
    HTMLUListElement();
    bool compact;
    ::html2::DOMString type;
};
class HTMLOListElement : ::html2::HTMLElement {
public:
    HTMLOListElement();
    bool compact;
    long start;
...
class HTMLDListElement : ::html2::HTMLElement {
public:
    HTMLDListElement();
    bool compact;
};
class HTMLDirectoryElement : ::html2::HTMLElement {
public:
    HTMLDirectoryElement();
    bool compact;
};
class HTMLMenuElement : ::html2::HTMLElement {
public:
    HTMLMenuElement();
    bool compact;
};
class HTMLLIElement : ::html2::HTMLElement {
public:
    HTMLLIElement();
    ::html2::DOMString type;
    long value;
};
class HTMLDivElement : ::html2::HTMLElement {
public:
    HTMLDivElement();
    ::html2::DOMString align;
};
class HTMLParagraphElement : ::html2::HTMLElement {
public:
    HTMLParagraphElement();
    ::html2::DOMString align;
};
class HTMLHeadingElement : ::html2::HTMLElement {
public:
    HTMLHeadingElement();
    ::html2::DOMString align;
};
class HTMLQuoteElement : ::html2::HTMLElement {
public:
    HTMLQuoteElement();
    ::html2::DOMString cite;
};
class HTMLPreElement : ::html2::HTMLElement {
public:
    HTMLPreElement();
    long width;
};
class HTMLBRElement : ::html2::HTMLElement {
public:
    HTMLBRElement();
    ::html2::DOMString clear;
};
class HTMLBaseFontElement : ::html2::HTMLElement {
public:
    HTMLBaseFontElement();
...
class HTMLFontElement : ::html2::HTMLElement {
public:
    HTMLFontElement();
    ::html2::DOMString color;
    ::html2::DOMString face;
...
class HTMLHRElement : ::html2::HTMLElement {
public:
    HTMLHRElement();
    ::html2::DOMString align;
    bool noShade;
...
class HTMLModElement : ::html2::HTMLElement {
public:
    HTMLModElement();
    ::html2::DOMString cite;
    ::html2::DOMString dateTime;
};
class HTMLAnchorElement : ::html2::HTMLElement {
public:
    HTMLAnchorElement();
    ::html2::DOMString accessKey;
    ::html2::DOMString charset;
...
class HTMLImageElement : ::html2::HTMLElement {
public:
    HTMLImageElement();
    ::html2::DOMString name;
    ::html2::DOMString align;
...
class HTMLObjectElement : ::html2::HTMLElement {
public:
    HTMLObjectElement();
    const   v8::Handle<v8::Value> /*::html2::HTMLFormElement*/  form;
...
class HTMLParamElement : ::html2::HTMLElement {
public:
    HTMLParamElement();
    ::html2::DOMString name;
    ::html2::DOMString type;
...
class HTMLAppletElement : ::html2::HTMLElement {
public:
    HTMLAppletElement();
    ::html2::DOMString align;
    ::html2::DOMString alt;
...
class HTMLMapElement : ::html2::HTMLElement {
public:
    HTMLMapElement();
    const   v8::Handle<v8::Value> /*::html2::HTMLCollection*/  areas;
    ::html2::DOMString name;
};
class HTMLAreaElement : ::html2::HTMLElement {
public:
    HTMLAreaElement();
    ::html2::DOMString accessKey;
    ::html2::DOMString alt;
...
class HTMLScriptElement : ::html2::HTMLElement {
public:
    HTMLScriptElement();
    ::html2::DOMString text;
    ::html2::DOMString htmlFor;
...
class HTMLTableElement : ::html2::HTMLElement {
public:
    HTMLTableElement();
...
class HTMLTableCaptionElement : ::html2::HTMLElement {
public:
    HTMLTableCaptionElement();
    ::html2::DOMString align;
};
class HTMLTableColElement : ::html2::HTMLElement {
public:
    HTMLTableColElement();
    ::html2::DOMString align;
    ::html2::DOMString ch;
...
class HTMLTableSectionElement : ::html2::HTMLElement {
public:
...
class HTMLTableRowElement : ::html2::HTMLElement {
public:
    HTMLTableRowElement();
    const  long rowIndex;
...
class HTMLTableCellElement : ::html2::HTMLElement {
public:
...
class HTMLFrameSetElement : ::html2::HTMLElement {
public:
    HTMLFrameSetElement();
    ::html2::DOMString cols;
    ::html2::DOMString rows;
};
class HTMLFrameElement : ::html2::HTMLElement {
public:
    HTMLFrameElement();
...
class HTMLIFrameElement : ::html2::HTMLElement {
public:
    HTMLIFrameElement();
    ::html2::DOMString align;
    ::html2::DOMString frameBorder;
