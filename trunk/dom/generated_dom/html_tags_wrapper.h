...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_DOMException, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_DOMException > node)
{
    if(!node) {
        node.reset(new js_dom_DOMException());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_DOMException >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_DOMImplementation, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_DOMImplementation > node)
{
    if(!node) {
        node.reset(new js_dom_DOMImplementation());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_DOMImplementation >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_Node, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_Node > node)
{
    if(!node) {
        node.reset(new js_dom_Node());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_Node >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_NodeList, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_NodeList > node)
{
    if(!node) {
        node.reset(new js_dom_NodeList());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_NodeList >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_NamedNodeMap, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_NamedNodeMap > node)
{
    if(!node) {
        node.reset(new js_dom_NamedNodeMap());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_NamedNodeMap >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_CharacterData, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_CharacterData > node)
{
    if(!node) {
        node.reset(new js_dom_CharacterData());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_CharacterData >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_Attr, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_Attr > node)
{
    if(!node) {
        node.reset(new js_dom_Attr());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_Attr >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_Element, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_Element > node)
{
    if(!node) {
        node.reset(new js_dom_Element());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_Element >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_dom_Node, true >(objToWrap, boost::shared_static_cast< js_dom_Node >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_Text, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_Text > node)
{
    if(!node) {
        node.reset(new js_dom_Text());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_Text >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_Comment, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_Comment > node)
{
    if(!node) {
        node.reset(new js_dom_Comment());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_Comment >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_dom_CharacterData, true >(objToWrap, boost::shared_static_cast< js_dom_CharacterData >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_CDATASection, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_CDATASection > node)
{
    if(!node) {
        node.reset(new js_dom_CDATASection());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_CDATASection >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_DocumentType, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_DocumentType > node)
{
    if(!node) {
        node.reset(new js_dom_DocumentType());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_DocumentType >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_dom_Node, true >(objToWrap, boost::shared_static_cast< js_dom_Node >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_Notation, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_Notation > node)
{
    if(!node) {
        node.reset(new js_dom_Notation());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_Notation >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_dom_Node, true >(objToWrap, boost::shared_static_cast< js_dom_Node >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_Entity, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_Entity > node)
{
    if(!node) {
        node.reset(new js_dom_Entity());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_Entity >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_dom_Node, true >(objToWrap, boost::shared_static_cast< js_dom_Node >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_EntityReference, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_EntityReference > node)
{
    if(!node) {
        node.reset(new js_dom_EntityReference());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_EntityReference >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_dom_Node, true >(objToWrap, boost::shared_static_cast< js_dom_Node >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_ProcessingInstruction, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_ProcessingInstruction > node)
{
    if(!node) {
        node.reset(new js_dom_ProcessingInstruction());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_ProcessingInstruction >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("data");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_DocumentFragment, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_DocumentFragment > node)
{
    if(!node) {
        node.reset(new js_dom_DocumentFragment());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_DocumentFragment >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_dom_Node, true >(objToWrap, boost::shared_static_cast< js_dom_Node >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_dom_Document, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_dom_Document > node)
{
    if(!node) {
        node.reset(new js_dom_Document());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_dom_Document >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_dom_Node, true >(objToWrap, boost::shared_static_cast< js_dom_Node >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_stylesheets_StyleSheet, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_stylesheets_StyleSheet > node)
{
    if(!node) {
        node.reset(new js_stylesheets_StyleSheet());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_stylesheets_StyleSheet >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_stylesheets_StyleSheetList, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_stylesheets_StyleSheetList > node)
{
    if(!node) {
        node.reset(new js_stylesheets_StyleSheetList());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_stylesheets_StyleSheetList >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_stylesheets_MediaList, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_stylesheets_MediaList > node)
{
    if(!node) {
        node.reset(new js_stylesheets_MediaList());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_stylesheets_MediaList >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_stylesheets_LinkStyle, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_stylesheets_LinkStyle > node)
{
    if(!node) {
        node.reset(new js_stylesheets_LinkStyle());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_stylesheets_LinkStyle >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_stylesheets_DocumentStyle, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_stylesheets_DocumentStyle > node)
{
    if(!node) {
        node.reset(new js_stylesheets_DocumentStyle());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_stylesheets_DocumentStyle >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_views_AbstractView, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_views_AbstractView > node)
{
    if(!node) {
        node.reset(new js_views_AbstractView());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_views_AbstractView >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_views_DocumentView, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_views_DocumentView > node)
{
    if(!node) {
        node.reset(new js_views_DocumentView());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_views_DocumentView >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSRuleList, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSRuleList > node)
{
    if(!node) {
        node.reset(new js_css_CSSRuleList());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSRuleList >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSRule, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSRule > node)
{
    if(!node) {
        node.reset(new js_css_CSSRule());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSRule >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSStyleRule, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSStyleRule > node)
{
    if(!node) {
        node.reset(new js_css_CSSStyleRule());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSStyleRule >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSMediaRule, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSMediaRule > node)
{
    if(!node) {
        node.reset(new js_css_CSSMediaRule());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSMediaRule >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_css_CSSRule, true >(objToWrap, boost::shared_static_cast< js_css_CSSRule >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSFontFaceRule, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSFontFaceRule > node)
{
    if(!node) {
        node.reset(new js_css_CSSFontFaceRule());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSFontFaceRule >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_css_CSSRule, true >(objToWrap, boost::shared_static_cast< js_css_CSSRule >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSPageRule, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSPageRule > node)
{
    if(!node) {
        node.reset(new js_css_CSSPageRule());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSPageRule >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("selectorText");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSImportRule, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSImportRule > node)
{
    if(!node) {
        node.reset(new js_css_CSSImportRule());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSImportRule >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_css_CSSRule, true >(objToWrap, boost::shared_static_cast< js_css_CSSRule >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSCharsetRule, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSCharsetRule > node)
{
    if(!node) {
        node.reset(new js_css_CSSCharsetRule());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSCharsetRule >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSUnknownRule, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSUnknownRule > node)
{
    if(!node) {
        node.reset(new js_css_CSSUnknownRule());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSUnknownRule >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_css_CSSRule, true >(objToWrap, boost::shared_static_cast< js_css_CSSRule >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSStyleDeclaration, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSStyleDeclaration > node)
{
    if(!node) {
        node.reset(new js_css_CSSStyleDeclaration());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSStyleDeclaration >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("cssText");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSValue, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSValue > node)
{
    if(!node) {
        node.reset(new js_css_CSSValue());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSValue >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("cssText");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSPrimitiveValue, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSPrimitiveValue > node)
{
    if(!node) {
        node.reset(new js_css_CSSPrimitiveValue());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSPrimitiveValue >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSValueList, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSValueList > node)
{
    if(!node) {
        node.reset(new js_css_CSSValueList());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSValueList >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_css_CSSValue, true >(objToWrap, boost::shared_static_cast< js_css_CSSValue >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_RGBColor, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_RGBColor > node)
{
    if(!node) {
        node.reset(new js_css_RGBColor());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_RGBColor >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_Rect, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_Rect > node)
{
    if(!node) {
        node.reset(new js_css_Rect());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_Rect >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_Counter, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_Counter > node)
{
    if(!node) {
        node.reset(new js_css_Counter());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_Counter >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_ElementCSSInlineStyle, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_ElementCSSInlineStyle > node)
{
    if(!node) {
        node.reset(new js_css_ElementCSSInlineStyle());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_ElementCSSInlineStyle >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSS2Properties, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSS2Properties > node)
{
    if(!node) {
        node.reset(new js_css_CSS2Properties());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSS2Properties >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_CSSStyleSheet, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_CSSStyleSheet > node)
{
    if(!node) {
        node.reset(new js_css_CSSStyleSheet());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_CSSStyleSheet >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_ViewCSS, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_ViewCSS > node)
{
    if(!node) {
        node.reset(new js_css_ViewCSS());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_ViewCSS >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_DocumentCSS, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_DocumentCSS > node)
{
    if(!node) {
        node.reset(new js_css_DocumentCSS());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_DocumentCSS >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_css_DOMImplementationCSS, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_css_DOMImplementationCSS > node)
{
    if(!node) {
        node.reset(new js_css_DOMImplementationCSS());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_css_DOMImplementationCSS >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_events_EventException, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_events_EventException > node)
{
    if(!node) {
        node.reset(new js_events_EventException());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_events_EventException >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("code");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_events_EventTarget, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_events_EventTarget > node)
{
    if(!node) {
        node.reset(new js_events_EventTarget());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_events_EventTarget >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_events_EventListener, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_events_EventListener > node)
{
    if(!node) {
        node.reset(new js_events_EventListener());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_events_EventListener >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_events_Event, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_events_Event > node)
{
    if(!node) {
        node.reset(new js_events_Event());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_events_Event >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_events_DocumentEvent, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_events_DocumentEvent > node)
{
    if(!node) {
        node.reset(new js_events_DocumentEvent());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_events_DocumentEvent >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_events_UIEvent, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_events_UIEvent > node)
{
    if(!node) {
        node.reset(new js_events_UIEvent());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_events_UIEvent >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_events_MouseEvent, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_events_MouseEvent > node)
{
    if(!node) {
        node.reset(new js_events_MouseEvent());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_events_MouseEvent >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_events_MutationEvent, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_events_MutationEvent > node)
{
    if(!node) {
        node.reset(new js_events_MutationEvent());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_events_MutationEvent >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_events_Event, true >(objToWrap, boost::shared_static_cast< js_events_Event >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLCollection, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLCollection > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLCollection());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLCollection >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLOptionsCollection, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLOptionsCollection > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLOptionsCollection());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLOptionsCollection >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLDocument, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLDocument > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLDocument());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLDocument >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLHtmlElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLHtmlElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLHtmlElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLHtmlElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLHeadElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLHeadElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLHeadElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLHeadElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLLinkElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLLinkElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLLinkElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLLinkElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("disabled");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLTitleElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLTitleElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLTitleElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLTitleElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLMetaElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLMetaElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLMetaElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLMetaElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("content");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLBaseElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLBaseElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLBaseElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLBaseElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("href");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLIsIndexElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLIsIndexElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLIsIndexElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLIsIndexElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLStyleElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLStyleElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLStyleElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLStyleElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("disabled");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLBodyElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLBodyElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLBodyElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLBodyElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLFormElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLFormElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLFormElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLFormElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("name");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLSelectElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLSelectElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLSelectElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLSelectElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLOptGroupElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLOptGroupElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLOptGroupElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLOptGroupElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("disabled");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLOptionElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLOptionElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLOptionElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLOptionElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLInputElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLInputElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLInputElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLInputElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLTextAreaElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLTextAreaElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLTextAreaElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLTextAreaElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("defaultValue");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLButtonElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLButtonElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLButtonElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLButtonElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("accessKey");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLLabelElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLLabelElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLLabelElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLLabelElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("accessKey");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLFieldSetElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLFieldSetElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLFieldSetElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLFieldSetElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    TreeNodeFromEntity< js_html2_HTMLElement, true >(objToWrap, boost::shared_static_cast< js_html2_HTMLElement >(node));
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLLegendElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLLegendElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLLegendElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLLegendElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("accessKey");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLUListElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLUListElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLUListElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLUListElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLOListElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLOListElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLOListElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLOListElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("compact");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLDListElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLDListElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLDListElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLDListElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("compact");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLDirectoryElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLDirectoryElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLDirectoryElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLDirectoryElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("compact");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLMenuElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLMenuElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLMenuElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLMenuElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("compact");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLLIElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLLIElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLLIElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLLIElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("type");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLDivElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLDivElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLDivElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLDivElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLParagraphElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLParagraphElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLParagraphElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLParagraphElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLHeadingElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLHeadingElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLHeadingElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLHeadingElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLQuoteElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLQuoteElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLQuoteElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLQuoteElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLPreElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLPreElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLPreElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLPreElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("width");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLBRElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLBRElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLBRElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLBRElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("clear");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLBaseFontElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLBaseFontElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLBaseFontElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLBaseFontElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("color");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLFontElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLFontElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLFontElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLFontElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("color");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLHRElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLHRElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLHRElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLHRElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLModElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLModElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLModElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLModElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("cite");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLAnchorElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLAnchorElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLAnchorElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLAnchorElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("accessKey");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLImageElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLImageElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLImageElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLImageElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("name");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLObjectElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLObjectElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLObjectElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLObjectElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("code");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLParamElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLParamElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLParamElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLParamElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("name");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLAppletElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLAppletElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLAppletElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLAppletElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLMapElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLMapElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLMapElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLMapElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("name");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLAreaElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLAreaElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLAreaElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLAreaElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("accessKey");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLScriptElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLScriptElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLScriptElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLScriptElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("text");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLTableElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLTableElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLTableElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLTableElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLTableCaptionElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLTableCaptionElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLTableCaptionElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLTableCaptionElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLTableColElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLTableColElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLTableColElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLTableColElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLTableSectionElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLTableSectionElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLTableSectionElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLTableSectionElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLTableRowElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLTableRowElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLTableRowElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLTableRowElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLTableCellElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLTableCellElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLTableCellElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLTableCellElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLFrameSetElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLFrameSetElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLFrameSetElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLFrameSetElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("cols");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLFrameElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLFrameElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLFrameElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLFrameElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_html2_HTMLIFrameElement, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_html2_HTMLIFrameElement > node)
{
    if(!node) {
        node.reset(new js_html2_HTMLIFrameElement());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_html2_HTMLIFrameElement >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("align");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_ranges_RangeException, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_ranges_RangeException > node)
{
    if(!node) {
        node.reset(new js_ranges_RangeException());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_ranges_RangeException >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
    try {
        webEngine::AttrMap::iterator attr = objToWrap->attr_list().find("code");
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_ranges_Range, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_ranges_Range > node)
{
    if(!node) {
        node.reset(new js_ranges_Range());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_ranges_Range >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_ranges_DocumentRange, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_ranges_DocumentRange > node)
{
    if(!node) {
        node.reset(new js_ranges_DocumentRange());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_ranges_DocumentRange >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_traversal_NodeIterator, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_traversal_NodeIterator > node)
{
    if(!node) {
        node.reset(new js_traversal_NodeIterator());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_traversal_NodeIterator >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_traversal_NodeFilter, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_traversal_NodeFilter > node)
{
    if(!node) {
        node.reset(new js_traversal_NodeFilter());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_traversal_NodeFilter >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_traversal_TreeWalker, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_traversal_TreeWalker > node)
{
    if(!node) {
        node.reset(new js_traversal_TreeWalker());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_traversal_TreeWalker >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
...
template <>
boost::shared_ptr<v8_wrapper::TreeNode> TreeNodeFromEntity< js_traversal_DocumentTraversal, true>(webEngine::html_entity_ptr objToWrap, boost::shared_ptr< js_traversal_DocumentTraversal > node)
{
    if(!node) {
        node.reset(new js_traversal_DocumentTraversal());
        node->m_this = v8::Persistent<v8::Object>::New(wrap_object< js_traversal_DocumentTraversal >(node.get()));
        node->m_tag = objToWrap->HtmlTag();
    }
