...
public:
    ...
    transport_url &BaseUrl(void)            {
        return(baseUrl);
    };
    void BaseUrl(const string &url) {
        baseUrl = url;
    };
    void BaseUrl(const transport_url &url)  {
        baseUrl = url;
    };
    //@}
    ...
    virtual int depth(void) {
        return depth_level;
    };
    virtual void depth(int lvl) {
        depth_level = lvl;
    };
    //@}
...
public:
    ...
    virtual void to_archive(we_oarchive &ar) = 0;
...
public:
    ...
    /// presents.
    transport_url &RealUrl(void)            {
        return(realUrl);
    };
    void RealUrl(const string &url) {
        realUrl = url;
    };
    void RealUrl(const transport_url &url)  {
        realUrl = url;
    };
    //@}
    ...
    ///
    /// Whatever the request already processed.
    boost::posix_time::ptime start_time(void)       {
        return start_tm;
    }
    void start_time(boost::posix_time::ptime stm)   {
        start_tm = stm;
    }
    //@}
...
public:
    ...
    const transport_url &base_url(void) const    {
        return(baseUrl);
    };
    ...
    const unsigned int &relocation_count(void) const     {
        return(relocCount);
    };
    void relocation_count(const unsigned int& relCount)  {
        relocCount = relCount;
    };
    //@}
    ...
    const unsigned int& site_depth(void) const   {
        return(siteDepth);
    };
    void site_depth(const unsigned int& sDepth)  {
        siteDepth = sDepth;
    };
    //@}
