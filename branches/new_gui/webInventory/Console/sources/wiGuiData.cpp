...
Tasks::Tasks( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_toolBarTasks->SetMargins( wxSize( 1,-1 ) );
...
Settings::Settings( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_tbServer->AddTool( wxID_TLPLGRELOAD, wxEmptyString, wxBitmap( reload_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Refresh plugins list"), wxEmptyString );
	m_tbServer->AddTool( wxID_TLSRVSTOP, wxEmptyString, wxBitmap( tree_no_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Stops the server"), wxEmptyString );
