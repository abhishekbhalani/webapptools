...
Tasks::Tasks( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	wxBoxSizer* bSzTab1;
	bSzTab1 = new wxBoxSizer( wxVERTICAL );
	
	m_splitTasks = new wxSplitterWindow( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxSP_3DSASH );
	m_splitTasks->Connect( wxEVT_IDLE, wxIdleEventHandler( Tasks::m_splitTasksOnIdle ), NULL, this );
	...
	m_plgBook = new wxListbook( m_panObjects, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLB_LEFT );
	...
	m_panTaskOpts = new wxPanel( m_plgBook, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer27;
	bSizer27 = new wxBoxSizer( wxVERTICAL );
	
	wxPropertyGrid* m_pgridGeneric;
	m_pgridGeneric = new wxPropertyGrid(m_panTaskOpts, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxPG_DEFAULT_STYLE);
	bSizer27->Add( m_pgridGeneric, 1, wxEXPAND, 0 );
	
	m_panTaskOpts->SetSizer( bSizer27 );
	m_panTaskOpts->Layout();
	bSizer27->Fit( m_panTaskOpts );
	m_plgBook->AddPage( m_panTaskOpts, _("a page"), false );
	...
	m_toolBarTasks->SetToolPacking( 5 );
	...
	m_staticText22 = new wxStaticText( m_toolBarTasks, wxID_ANY, _("Lines to retrieve:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText22->Wrap( -1 );
	m_toolBarTasks->AddControl( m_staticText22 );
	m_spinLinesTsk = new wxSpinCtrl( m_toolBarTasks, wxID_ANY, wxT("10"), wxDefaultPosition, wxSize( 50,-1 ), wxSP_ARROW_KEYS, 0, 100, 10 );
	m_toolBarTasks->AddControl( m_spinLinesTsk );
	
	m_chAppendTsk = new wxCheckBox( m_toolBarTasks, wxID_ANY, _(" Append to log"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
	m_chAppendTsk->SetValue(true);
	
	m_toolBarTasks->AddControl( m_chAppendTsk );
	m_toolBarTasks->AddTool( wxID_TLREFRTSKLOG, _("tool"), wxBitmap( reload_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Refresh task log"), wxEmptyString );
	m_toolBarTasks->AddTool( wxID_TLSAVETSKLOG, _("tool"), wxBitmap( flsave_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Save task log to file"), wxEmptyString );
	...
	this->SetSizer( bSzTab1 );
	this->Layout();
	
	// Connect Events
	this->Connect( wxID_TOOLNEW, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnAddObject ) );
	this->Connect( wxID_TOOLEDIT, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnEditObject ) );
	this->Connect( wxID_TOOLDEL, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnDelObject ) );
	m_lstObjectList->Connect( wxEVT_KILL_FOCUS, wxFocusEventHandler( Tasks::OnTaskKillFocus ), NULL, this );
	m_lstObjectList->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( Tasks::OnSelectObject ), NULL, this );
	m_chProfile->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( Tasks::OnChangeProfile ), NULL, this );
	this->Connect( wxID_TLPROFNEW, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnAddProfile ) );
	this->Connect( wxID_TLPROFCLONE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnCopyProfile ) );
	this->Connect( wxID_TLPROFDEL, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnDelProfile ) );
	this->Connect( wxID_TLPROFSAVE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnTaskApply ) );
	this->Connect( wxID_TOOLGO, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnRunTask ) );
	m_bpAddPlugin->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Tasks::OnAddPlugin ), NULL, this );
	m_bpDelPlugin->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Tasks::OnRemovePlugin ), NULL, this );
	m_plgBook->Connect( wxEVT_COMMAND_LISTBOOK_PAGE_CHANGING, wxListbookEventHandler( Tasks::OnOptionsPageChanging ), NULL, this );
	this->Connect( wxID_TOOLPAUSE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnPauseTask ) );
	this->Connect( wxID_TOOLSTOP, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnCancelTask ) );
	m_lstTaskList->Connect( wxEVT_COMMAND_LIST_COL_CLICK, wxListEventHandler( Tasks::OnSortItems ), NULL, this );
	m_lstTaskList->Connect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( Tasks::OnTaskSelected ), NULL, this );
}

Tasks::~Tasks()
{
	// Disconnect Events
	this->Disconnect( wxID_TOOLNEW, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnAddObject ) );
	this->Disconnect( wxID_TOOLEDIT, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnEditObject ) );
	this->Disconnect( wxID_TOOLDEL, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnDelObject ) );
	m_lstObjectList->Disconnect( wxEVT_KILL_FOCUS, wxFocusEventHandler( Tasks::OnTaskKillFocus ), NULL, this );
	m_lstObjectList->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( Tasks::OnSelectObject ), NULL, this );
	m_chProfile->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( Tasks::OnChangeProfile ), NULL, this );
	this->Disconnect( wxID_TLPROFNEW, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnAddProfile ) );
	this->Disconnect( wxID_TLPROFCLONE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnCopyProfile ) );
	this->Disconnect( wxID_TLPROFDEL, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnDelProfile ) );
	this->Disconnect( wxID_TLPROFSAVE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnTaskApply ) );
	this->Disconnect( wxID_TOOLGO, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnRunTask ) );
	m_bpAddPlugin->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Tasks::OnAddPlugin ), NULL, this );
	m_bpDelPlugin->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Tasks::OnRemovePlugin ), NULL, this );
	m_plgBook->Disconnect( wxEVT_COMMAND_LISTBOOK_PAGE_CHANGING, wxListbookEventHandler( Tasks::OnOptionsPageChanging ), NULL, this );
	this->Disconnect( wxID_TOOLPAUSE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnPauseTask ) );
	this->Disconnect( wxID_TOOLSTOP, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Tasks::OnCancelTask ) );
	m_lstTaskList->Disconnect( wxEVT_COMMAND_LIST_COL_CLICK, wxListEventHandler( Tasks::OnSortItems ), NULL, this );
	m_lstTaskList->Disconnect( wxEVT_COMMAND_LIST_ITEM_SELECTED, wxListEventHandler( Tasks::OnTaskSelected ), NULL, this );
}
...
Settings::Settings( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	...
	m_stConVers = new wxStaticText( this, wxID_ANY, _("Console version:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stConVers->Wrap( -1 );
	fgSizer2->Add( m_stConVers, 0, wxALL, 5 );
	
	m_stConVersData = new wxStaticText( this, wxID_ANY, _("unknown"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stConVersData->Wrap( -1 );
	fgSizer2->Add( m_stConVersData, 0, wxALL, 5 );
	
	m_stServer = new wxStaticText( this, wxID_ANY, _("Scanner address:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stServer->Wrap( -1 );
	...
	wxArrayString m_chServersChoices;
	m_chServers = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxSize( 250,-1 ), m_chServersChoices, 0 );
	m_chServers->SetSelection( 0 );
	bSizer6->Add( m_chServers, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_toolBarSrv = new wxToolBar( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTB_FLAT|wxTB_HORIZONTAL|wxTB_NODIVIDER );
	...
	m_stSrvVers = new wxStaticText( this, wxID_ANY, _("Scanner version:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stSrvVers->Wrap( -1 );
	fgSizer2->Add( m_stSrvVers, 0, wxALL, 5 );
	
	m_stSrvVersData = new wxStaticText( this, wxID_ANY, _("unknown"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stSrvVersData->Wrap( -1 );
	fgSizer2->Add( m_stSrvVersData, 0, wxALL, 5 );
	
	m_stLang = new wxStaticText( this, wxID_ANY, _("Interface Language:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stLang->Wrap( -1 );
	...
	m_chLangs = new wxChoice( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_chLangsNChoices, m_chLangsChoices, 0 );
	m_chLangs->SetSelection( 0 );
	m_chLangs->SetMinSize( wxSize( 250,-1 ) );
	
	bSizer7->Add( m_chLangs, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_toolBarLang = new wxToolBar( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTB_FLAT|wxTB_HORIZONTAL|wxTB_NODIVIDER );
	...
	m_stLangRestart = new wxStaticText( this, wxID_ANY, _("Need to restart to apply changes"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_stLogging = new wxStaticText( this, wxID_ANY, _("Write console logs:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_stLogging->Wrap( -1 );
	fgSizer2->Add( m_stLogging, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_chLogging = new wxCheckBox( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_pnServer = new wxPanel( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	fgSrvSizer = new wxFlexGridSizer( 2, 2, 0, 0 );
	fgSrvSizer->SetFlexibleDirection( wxBOTH );
	fgSrvSizer->SetNonFlexibleGrowMode( wxFLEX_GROWMODE_SPECIFIED );
	
	m_staticText18 = new wxStaticText( m_pnServer, wxID_ANY, _("Scanner storage:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText18->Wrap( -1 );
	fgSrvSizer->Add( m_staticText18, 0, wxALL, 5 );
	...
	m_tbServer->AddTool( wxID_TLPLGRELOAD, wxEmptyString, wxBitmap( refresh_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Refresh plugins list"), wxEmptyString );
	m_tbServer->AddTool( wxID_TLSRVRESTART, wxEmptyString, wxBitmap( reload_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Restart server"), wxEmptyString );
	m_tbServer->AddTool( wxID_TLSRVSTOP, wxEmptyString, wxBitmap( btnStop_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Stops the server"), wxEmptyString );
	m_tbServer->AddTool( wxID_TLSRVLOG, wxEmptyString, wxBitmap( opts_audit_xpm ), wxNullBitmap, wxITEM_NORMAL, _("View server log"), wxEmptyString );
	m_tbServer->Realize();
	
	bSizer12->Add( m_tbServer, 0, wxALIGN_CENTER_VERTICAL, 0 );
	
	fgSrvSizer->Add( bSizer12, 1, wxEXPAND, 5 );
	
	m_staticText19 = new wxStaticText( m_pnServer, wxID_ANY, _("Scanner plugins:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText19->Wrap( -1 );
	fgSrvSizer->Add( m_staticText19, 0, wxALL, 5 );
	
	m_pgrdManager = new wxPropertyGridManager(m_pnServer, wxID_PLUG_INFO, wxDefaultPosition, wxDefaultSize, wxPGMAN_DEFAULT_STYLE|wxPG_BOLD_MODIFIED|wxTAB_TRAVERSAL);
	m_pgrdManager->SetExtraStyle( wxPG_EX_MODE_BUTTONS ); 
	m_pgrdManager->SetMinSize( wxSize( 520,300 ) );
	
	fgSrvSizer->Add( m_pgrdManager, 1, wxEXPAND|wxLEFT, 5 );
	
	
	fgSrvSizer->Add( 120, 0, 1, wxEXPAND, 5 );
	
	m_pnServer->SetSizer( fgSrvSizer );
	m_pnServer->Layout();
	fgSrvSizer->Fit( m_pnServer );
	...
	// Connect Events
	m_chServers->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( Settings::OnChangeSrv ), NULL, this );
	this->Connect( wxID_TLCONNECT, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnConnect ) );
	this->Connect( wxID_TLNEW, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnAddServer ) );
	this->Connect( wxID_TLEDIT, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnEditServer ) );
	this->Connect( wxID_TLDELETE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnDelServer ) );
	this->Connect( wxID_TLLANGAPPLY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnLangChange ) );
	m_bpStorageApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Settings::OnStorageChange ), NULL, this );
	this->Connect( wxID_TLPLGRELOAD, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnPlgRefresh ) );
	this->Connect( wxID_TLSRVRESTART, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnSrvRestart ) );
	this->Connect( wxID_TLSRVSTOP, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnSrvStop ) );
	this->Connect( wxID_TLSRVLOG, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnServerLogs ) );
}

Settings::~Settings()
{
	// Disconnect Events
	m_chServers->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( Settings::OnChangeSrv ), NULL, this );
	this->Disconnect( wxID_TLCONNECT, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnConnect ) );
	this->Disconnect( wxID_TLNEW, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnAddServer ) );
	this->Disconnect( wxID_TLEDIT, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnEditServer ) );
	this->Disconnect( wxID_TLDELETE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnDelServer ) );
	this->Disconnect( wxID_TLLANGAPPLY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnLangChange ) );
	m_bpStorageApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Settings::OnStorageChange ), NULL, this );
	this->Disconnect( wxID_TLPLGRELOAD, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnPlgRefresh ) );
	this->Disconnect( wxID_TLSRVRESTART, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnSrvRestart ) );
	this->Disconnect( wxID_TLSRVSTOP, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnSrvStop ) );
	this->Disconnect( wxID_TLSRVLOG, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Settings::OnServerLogs ) );
}

Reports::Reports( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	wxBoxSizer* bSizer13;
	...
	m_toolBarFilter->AddTool( wxID_TLREFRESH, wxEmptyString, wxBitmap( reload_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Refresh reports list"), wxEmptyString );
	m_toolBarFilter->AddTool( wxID_TLFILTER, wxEmptyString, wxBitmap( filter_xpm ), wxNullBitmap, wxITEM_CHECK, _("Apply filter"), wxEmptyString );
	...
	m_toolBarFilter->AddTool( wxID_TLDATE, wxEmptyString, wxBitmap( date_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Date filter mode"), wxEmptyString );
	...
	m_toolBarFilter->AddTool( wxID_TLSTATUS, wxEmptyString, wxBitmap( flstatus_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Filter by scan status"), wxEmptyString );
	m_toolBarFilter->AddTool( wxID_TLSAVE, wxEmptyString, wxBitmap( flsave_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Save and load filters"), wxEmptyString );
	m_toolBarFilter->Realize();
	
	bSizer14->Add( m_toolBarFilter, 0, wxEXPAND, 5 );
	
	m_tbRepPlugs = new wxToolBar( m_panRepTree, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTB_FLAT|wxTB_HORIZONTAL|wxTB_NODIVIDER );
	m_tbRepPlugs->SetToolBitmapSize( wxSize( 16,16 ) );
	wxStaticText* m_stReporter;
	m_stReporter = new wxStaticText( m_tbRepPlugs, wxID_ANY, _(" Reporter plugin: "), wxDefaultPosition, wxDefaultSize, 0 );
	m_stReporter->Wrap( -1 );
	m_tbRepPlugs->AddControl( m_stReporter );
	wxArrayString m_chReportersChoices;
	m_chReporters = new wxChoice( m_tbRepPlugs, wxID_ANY, wxDefaultPosition, wxDefaultSize, m_chReportersChoices, 0 );
	m_chReporters->SetSelection( 0 );
	m_tbRepPlugs->AddControl( m_chReporters );
	m_tbRepPlugs->AddTool( wxID_ANY, wxEmptyString, wxBitmap( btnApply16_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Change report plugin"), wxEmptyString );
	m_tbRepPlugs->AddTool( wxID_ANY, wxEmptyString, wxBitmap( plugOpen_xpm ), wxNullBitmap, wxITEM_NORMAL, _("Open plugin"), wxEmptyString );
	m_tbRepPlugs->Realize();
	
	bSizer14->Add( m_tbRepPlugs, 0, wxEXPAND, 5 );
	...
	// Connect Events
	this->Connect( wxID_TLREFRESH, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsRefresh ) );
	this->Connect( wxID_TLFILTER, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsFilter ) );
	m_chTaskFilter->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( Reports::OnReportTskFilter ), NULL, this );
	this->Connect( wxID_TLDATE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsDate ) );
	m_dateFilter->Connect( wxEVT_DATE_CHANGED, wxDateEventHandler( Reports::OnReportDateFilter ), NULL, this );
	this->Connect( wxID_TLSTATUS, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsStatus ) );
	this->Connect( wxID_TLSAVE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsSave ) );
	m_chReporters->Connect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( Reports::OnReporterChanged ), NULL, this );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReporterApply ) );
	this->Connect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReporterLoad ) );
	m_treeScans->Connect( wxEVT_COMMAND_TREE_ITEM_EXPANDING, wxTreeEventHandler( Reports::OnReportExpand ), NULL, this );
	m_treeScans->Connect( wxEVT_COMMAND_TREE_SEL_CHANGED, wxTreeEventHandler( Reports::OnReportSelected ), NULL, this );
}

Reports::~Reports()
{
	// Disconnect Events
	this->Disconnect( wxID_TLREFRESH, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsRefresh ) );
	this->Disconnect( wxID_TLFILTER, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsFilter ) );
	m_chTaskFilter->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( Reports::OnReportTskFilter ), NULL, this );
	this->Disconnect( wxID_TLDATE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsDate ) );
	m_dateFilter->Disconnect( wxEVT_DATE_CHANGED, wxDateEventHandler( Reports::OnReportDateFilter ), NULL, this );
	this->Disconnect( wxID_TLSTATUS, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsStatus ) );
	this->Disconnect( wxID_TLSAVE, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReportsSave ) );
	m_chReporters->Disconnect( wxEVT_COMMAND_CHOICE_SELECTED, wxCommandEventHandler( Reports::OnReporterChanged ), NULL, this );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReporterApply ) );
	this->Disconnect( wxID_ANY, wxEVT_COMMAND_TOOL_CLICKED, wxCommandEventHandler( Reports::OnReporterLoad ) );
	m_treeScans->Disconnect( wxEVT_COMMAND_TREE_ITEM_EXPANDING, wxTreeEventHandler( Reports::OnReportExpand ), NULL, this );
	m_treeScans->Disconnect( wxEVT_COMMAND_TREE_SEL_CHANGED, wxTreeEventHandler( Reports::OnReportSelected ), NULL, this );
}

PluginSettings::PluginSettings( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style ) : wxPanel( parent, id, pos, size, style )
{
	wxBoxSizer* bSizer;
